"""
Realiza geração e reconstrução de imagens médicas usando modelos de autoencoder e difusão.
Avalia as reconstruções com métricas quantitativas e salva resultados em disco.
"""
