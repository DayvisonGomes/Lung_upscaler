"""
Calcula métricas de avaliação (PSNR, MAE, MSSIM, SSIM) entre imagens originais e upscaladas.
Gera logs e estatísticas para validação dos modelos de upscaling.
"""
