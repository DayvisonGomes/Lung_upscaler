"""
Calcula a métrica FID (Frechet Inception Distance) entre imagens originais e upscaladas para avaliação de qualidade.
Utiliza MedicalNet para extração de features e MONAI para processamento das imagens.
"""
