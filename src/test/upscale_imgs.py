"""
Script para realizar upscaling de imagens médicas utilizando modelos de autoencoder e difusão.
Salva imagens geradas e originais, além de logs de métricas.
"""
