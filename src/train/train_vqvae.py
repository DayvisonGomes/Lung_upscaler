"""
Script para treinar o modelo VQ-VAE com imagens médicas.
Inclui configuração via argumentos, carregamento de dados, inicialização de modelo, treinamento adversarial e salvamento de checkpoints.
"""
