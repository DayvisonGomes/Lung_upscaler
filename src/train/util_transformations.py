"""
Funções para criação de dataloaders e definição de transformações para imagens médicas.
Inclui métodos para diferentes pipelines de treinamento e manipulação de dados.
"""
...
def get_upsampler_dataloader(batch_size: int,training_ids: str, validation_ids: str, num_workers: int = 8):
    ...
    train_datalist = get_datalist(ids_path=training_ids)[:15000]
