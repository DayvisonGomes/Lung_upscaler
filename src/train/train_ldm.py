"""
Script para treinar o modelo Latent Diffusion Model (LDM) para upscaling de imagens médicas.
Carrega dados, inicializa autoencoder e modelo de difusão, realiza treinamento e validação, e salva checkpoints.
"""
...
if __name__ == '__main__':
    ...
    output_dir = r"D:\Users\dayv\lung_upscaler\mamografIA_upscaler\outputs\runs_final"
    ...
    run = wandb.init(project="Artigo", name="LDM-Clinical-Lung-Multiclass-Mask-Asr", config=config_wandb)
