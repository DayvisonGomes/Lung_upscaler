"""
Treinamento do modelo Latent Diffusion Model (LDM) sem imagens de baixa resolução.
Carrega dados, inicializa modelos, realiza treinamento e validação, e salva resultados.
"""
