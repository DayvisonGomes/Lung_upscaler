"""
Script para treinar o modelo AutoencoderKL com imagens médicas.
Inclui configuração via argumentos, carregamento de dados, inicialização de modelo, treinamento adversarial e registro no WandB.
"""
