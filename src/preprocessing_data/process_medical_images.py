"""
Processa imagens médicas para geração de arquivos .tsv de treino, validação e teste.
Inclui funções para flip, rotação, extração de índice, atribuição de classe e geração de imagens aumentadas.
"""
