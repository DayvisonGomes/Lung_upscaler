"""
Extrai features radiômicas de imagens médicas usando SimpleITK e pyradiomics.
Gera máscaras de ROI, calcula médias por classe BIRADS e salva resultados em JSON.
"""
