"""
Gera máscaras binárias de pulmão para imagens CT usando windowing e limiarização.
Salva máscaras como arquivos TIFF para conjuntos de treino, teste e validação.
"""
