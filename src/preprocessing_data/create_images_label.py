"""
Classifica imagens quanto ao brilho (Densa/Menos Densa) usando transformações MONAI.
Gera arquivos CSV com as classificações para treino, validação e teste.
"""
