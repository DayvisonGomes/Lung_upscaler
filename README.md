...
URL = {https://doi.org/10.1117/1.JMI.13.S11203}
}
```
...
### 4. Treinamento do AutoencoderKL:
...
### 5. Treinamento do Modelo de Difusão Latente:
...
```
### 6. Realizar upscale nas imagens de teste e calcular as métricas:
